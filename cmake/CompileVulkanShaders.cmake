...
function(target_compile_shaders target)
    ...
    # Define <UPPERCASE-TARGET-NAME>_COMPILED_SHADER_DIR in the target
    string(MAKE_C_IDENTIFIER ${target} TARGET_IDENTIFIER)
    string(TOUPPER ${TARGET_IDENTIFIER} TARGET_IDENTIFIER)
    target_compile_definitions(${target} PRIVATE ${TARGET_IDENTIFIER}_COMPILED_SHADER_DIR="${CMAKE_CURRENT_BINARY_DIR}")
