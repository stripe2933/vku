...
public:
    ...
    explicit TriangleRenderer(
        ...
        pipeline { createPipeline(device, colorAttachmentFormat, depthAttachmentFormat) } { }
...
#else
                vku::Shader::readCode(VKU_EXAMPLES_02_HEADLESS_MSAA_TRIANGLE_COMPILED_SHADER_DIR "/shaders/triangle.vert.spv"),
#endif
            },
            vku::Shader {
...
#else
                vku::Shader::readCode(VKU_EXAMPLES_02_HEADLESS_MSAA_TRIANGLE_COMPILED_SHADER_DIR "/shaders/triangle.frag.spv"),
#endif
            });
